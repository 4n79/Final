		 ...
		 //if answer1 is marked correct, do this--
			if($isCorrect == "answer1"){
				...
				$msg = 'Thanks, question no.'.$lastId.' has been added';
		  		header('location: admins2.php?msg='.$msg.'');
				exit();
			}
...
*/
			...
			function editQ_submit(){
				document.deleteedit.action = "admins2.php";
...
<li><a href="admins.php"><span>Admin Home</span></a></li>
		        <li class='active'><a href="javascript:open_overlay('regNewQuiz','regNewAdmin');"> <span>Add Quiz</span></a></li>
...
<div class="content" id="tf" style="margin-bottom: 100px;">
    		...
    		<form action="admins2.php" name="addQuestion" method="POST">
 		...
 		<div class="content" id="mc" style="margin-bottom: 100px;">
    		...
    		<form action="admins2.php" name="addMcQuestion" method="POST">
       ...
       <div id="p01">
 <img src="ism/image/slides/16.jpg" height="506px" width="100%"> 
</div>
