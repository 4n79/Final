		 ...
		 //if answer1 is marked correct, do this--
			if($isCorrect == "answer1"){
				...
				$msg = 'Thanks, question no.'.$lastId.' has been added';
		  		header('location: admins1.php?msg='.$msg.'');
				exit();
			}
...
*/
			...
			function editQ_submit(){
				document.deleteedit.action = "admins1.php";
...
<li><a href="admins.php"><span>Admin Home</span></a></li>
		        <li class='active'><a href="admins3.php"><span>Create Question</span></a></li>
				
				
				<li><a href="javascript:view_questions('allthequestions');"><span>View Question</span></a></li>
				 <li class='active'><a href="javascript:edit_question('allthequestions');"><span>Edit Question</span></a></li>
				 <li class='active'><a href="javascript:delete_some_questions('allthequestions');"><span>Delete Questions</span></a></li>
				 <li class='active'><a href="javascript:resetQuiz();"><span>Delete ALL Question</span></a></li>
...
<div class="content" id="tf" style="margin-bottom: 100px;">
    		...
    		<form action="admins1.php" name="addQuestion" method="POST">
 		...
 		<div class="content" id="mc" style="margin-bottom: 100px;">
    		...
    		<form action="admins1.php" name="addMcQuestion" method="POST">
       ...
       <div id="p01">
 <img src="ism/image/slides/15.jpg" height="506px" width="100%"> 
</div>
