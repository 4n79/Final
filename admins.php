		 ...
		 //if answer1 is marked correct, do this--
			if($isCorrect == "answer1"){
				...
				$msg = 'Thanks, question no.'.$lastId.' has been added';
		  		header('location: admins.php?msg='.$msg.'');
				exit();
			}
...
*/
			...
			function editQ_submit(){
				document.deleteedit.action = "admins.php";
...
<li class='active'> <a href=""> <span>Welcome Admin</span></a></li>
				...
				<li><a href="admins1.php"><span>Question Management</span></a></li>
				
				 <li><a href="admins2.php"><span>Quiz Management</span> </a></li>
...
<div class="content" id="tf" style="margin-bottom: 100px;">
    		...
    		<form action="admins.php" name="addQuestion" method="POST">
 		...
 		<div class="content" id="mc" style="margin-bottom: 100px;">
    		...
    		<form action="admins.php" name="addMcQuestion" method="POST">
...
<div id="p01">
 <img src="ism/image/slides/17.jpg" height="506px" width="100%"> 
</div>
